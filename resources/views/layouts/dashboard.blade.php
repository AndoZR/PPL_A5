...
@section('content')
{{-- section ini isinya harus sama dengan @yield() yang ada di app.blade --}}
<div class="row">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp {{ $jumlahPendapatan }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Rp{{ $jumlahPengeluaran }}</div>
                    </div>
                    <div class="col-auto">
