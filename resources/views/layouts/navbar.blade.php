            ...
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                ...
                @if(isset($collectnotif))
                    @foreach ($collectnotif as $item)
                        <span class="badge badge-danger badge-counter">{{ $no++ }}</span>
                    @endforeach
                @endif
            </a>
            <!-- Dropdown - Alerts -->
            <div style="max-width:500px; max-height:300px; overflow-y: auto;" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
